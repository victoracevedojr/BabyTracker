...
<html>
	<head>
	<meta charset="UTF-8">
		<title>Baby Tracker: Add a Diaper Change</title>
	...
	<body class="bg-amber-50">
		...
		<div class="mx-auto px-20">
			<div class="flex justify-between my-5 w-1/2 mx-auto items-center">
				<p class="text-4xl text-center">Add a Diaper Change</p>
			...
			<div class="my-3">
				<table class="table-auto w-1/2 my-3 mx-auto text-2xl border border-2 border-separate border-spacing-0 border-amber-400 rounded-lg">
					<form:form action="/babies/${baby.id}/diaper/new" method="post" modelAttribute="newDiaper" class="form">
						<tbody>
							<tr class="h-16">
								<td class="p-5">
