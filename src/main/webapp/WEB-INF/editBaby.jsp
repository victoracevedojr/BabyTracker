...
<html>
	<head>
	<meta charset="UTF-8">
		<title>Baby Tracker: Edit Baby</title>
	...
	<body class="bg-amber-50">
		...
		<div class="mx-auto px-20">
			<div class="flex justify-between my-5 w-1/2 mx-auto items-center">
				<p class="text-4xl text-center">Edit Baby Information</p>
				<a href="/babies/${thisBaby.id}${babyToUpdate.id}" class="text-center hover:italic rounded bg-slate-300 hover:bg-slate-400 w-24 text-lg">Cancel</a>
			</div>
			<div class="my-3">
				<table class="table-auto w-1/2 my-3 mx-auto text-2xl border border-2 border-separate border-spacing-0 border-amber-400 rounded-lg">
					<form:form action="/babies/${babyId}/edit" method="put" modelAttribute="babyToUpdate" class="form" enctype="multipart/form-data">
						<tbody>
							<tr class="h-16">
								<td class="p-5">
								...
								<td class="p-5">
									<form:input path="firstName" value="${thisBaby.firstName}" class="shadow-inner rounded w-full border border-amber-200 p-1 focus:shadow-lg focus:shadow-amber-300" placeholder="Please enter a first name"/>
								</td>
							</tr>
							<tr class="h-16">
								<td class="p-5">
								...
								<td class="p-5">
									<form:input path="lastName" value="${thisBaby.lastName}" class="shadow-inner rounded w-full border border-amber-200 p-1 focus:shadow-lg focus:shadow-amber-300" placeholder="Please enter a last name"/>
								</td>
							</tr>
							<tr class="h-16">
								<td class="p-5">
								...
								<td class="p-5">
									<c:if test="${babyToUpdate.gender eq 'Male'}">
										<div>
									...
									<c:if test="${babyToUpdate.gender eq 'Female'}">
										<div>
							...
							<tr class="h-16">
								...
								<td class="p-5">
									<form:input path="birthday" type="date" value="${babyToUpdate.birthday}"  class="shadow-inner rounded w-full border border-amber-200 p-1 focus:shadow-lg focus:shadow-amber-300"/>
								</td>
							</tr>
							<tr class="h-16">
